...
abstract class GCreateUserData_createUser
  ...
  static void _initializeBuilder(GCreateUserData_createUserBuilder b) =>
      b..G__typename = 'CreateUserMutation';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  bool? get success;
  String? get message;
  GCreateUserData_createUser_user? get user;
...
abstract class GCreateUserData_createUser_user
    implements
        Built<GCreateUserData_createUser_user,
            GCreateUserData_createUser_userBuilder> {
  GCreateUserData_createUser_user._();

  factory GCreateUserData_createUser_user(
          [Function(GCreateUserData_createUser_userBuilder b) updates]) =
      _$GCreateUserData_createUser_user;

  static void _initializeBuilder(GCreateUserData_createUser_userBuilder b) =>
  ...
  String get username;
  String get email;
  static Serializer<GCreateUserData_createUser_user> get serializer =>
      _$gCreateUserDataCreateUserUserSerializer;
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GCreateUserData_createUser_user.serializer,
        this,
      ) as Map<String, dynamic>);
  static GCreateUserData_createUser_user? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
        GCreateUserData_createUser_user.serializer,
        json,
      );
